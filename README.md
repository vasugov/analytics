...
## Architecture
1. **Data Ingestion Layer**: Collects and buffers live NFL play-by-play events (Kafka, APIs, Redis Streams).  
2. **Event-Driven Engine**: Consumes events, updates game state, triggers metric computations (Python/Node.js, Redis, optional Flink/Spark).  
